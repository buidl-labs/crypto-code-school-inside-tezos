...
2. Since your `Plant` contract is going to be deployed on the Tezos blockchain, using the rules you have defined in your `Plant` contract, the plant can keep fighting without requiring your attention. ⚔️
