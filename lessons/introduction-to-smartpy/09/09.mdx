...
### String: 
A string is traditionally a sequence of characters eg: <span class="string-highlight">"peashooter”.</span>
...
2. We will use `scenario.verify`, to check the current whether plant is alive or not by checking the current value of `is_alive` state variable:
