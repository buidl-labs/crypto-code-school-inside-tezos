...
1. Non-negative integers: eg: <span class="string-highlight">4</span> is represented by `sp.TInt`
2. Signed integers: eg: <span class="string-highlight">-42</span> is represented by by `sp.TNat`
...
We have left this exercise a little vauge so that you can practise working with state variables and entry point functions. Check out [Chapter 5](/lesson/chapter-05) and [Chapter 7](/lesson/chapter-07) for a quick refresher.  
...
You can also tinker around with the final code on [SmartPy’s online IDE](https://smartpy.io/demo/index.html?code=eJylU8GO2yAQvfsrRsnFViNrd48rRWrVXnqo1MPeETHjDVobEOBkvV_fgWA7JGmVVTlYgN@8efOYkb3R1oPrufVmBO7AmaJoOu4c_O648qUz9XetvOWNr54LoCWwBcakkp6x0mHXbkA6xjt5wIQIK_yoA6icr8JSvEfYwsogd3utPdrVJgNMVASatpsiQ6zX8E0IaLS2Qirukb0DV9nFCAduJd916C5Df5Ik2Gm_h6OkzwMMTqpXKpvE@shDWyIBi85g4yl_N0LGkmXeptDyodr8FTaeYLQnWAZaTnHzlVBIbo_MaCKd_W72XL0iC@4lyxUe47F6htxzwT2vk80TaM4RoWv4ga1UCL0@INtrKz_ohXlHdcbcEHNDOygqX6t_CruiSPIGI0LhXl@2RJSXOfhlu6CL2Ylc5AGtl81_SFwIPitwzAUWIQ0Xgnl0vpza@YUOYMLAuJivJyGrqgjpIy4lcQ0qakx9aofwh01XZbXUHoliAtak2aOINJBnA_JiBzwLm9lJ8A2Ku4H1ebetzKDeyO9lXm9krMle2Y7lLbLo5yL6SvUaonmjHuxsXXrk6Xkd7LDTxwT_RaCTbGi1PXIrYDfCU5zdsz6hu8e7qr1u4af7Ta0vu@sxxf4BWB2wkg--). Try running the test by clicking on the ▶️ button!
