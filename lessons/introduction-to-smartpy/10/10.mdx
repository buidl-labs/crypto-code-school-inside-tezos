---
title: Dealing with integers in Smartpy
chapter: Chapter 10
slug: chapter-10
editor:
  language: python
...
## x_coordinate is a variable that stores the current x coordinate of your plant. 
## Can be range between [-10, 10]. Useful when you want to move your plant horizontally. 
self.init(coordinate_x = 0)

## position_y_coordinate is a variable that stores the current y coordinate of your plant. 
## Can range between [1, 5].  Useful when you want to move your plant vertically.
...
Our current plant lacks movement abilities!
