...
2. Define `name` variable and initialize it’s value with <span class="string-highlight">“terminator”</span> since that is the name of the species of the CryptoBot that you are growing. 
