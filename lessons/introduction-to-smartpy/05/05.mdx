...
A "state" represents the current status of the smart contract like a visual screenshot. If you'd like your smart contract to do anything - like building shooting ability in your `Plant` contract - it will involve changing the contract's current state. 
...
2. Define `name` variable and initialize it’s value with <span class="string-highlight">“peashooter”</span> since that is the name of the species of the plant that you are growing. 
