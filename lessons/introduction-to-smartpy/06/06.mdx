...
Hence writing test code to supplement your smart contract is one of the most important concepts to learn! 

Testing also helps you simulate your smart contract - of how it would be likely behave when deployed on the blockchain. 
