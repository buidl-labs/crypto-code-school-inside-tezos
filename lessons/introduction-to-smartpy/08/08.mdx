...
editor:
  ...
  startingCode: |
    ...
    ## In Plant contract shown below, 
    ## what is the type of `name` that SmartPy will automatically infer?
...
Just to practise what you learnt above: 

**In `Plant` contract shown to your left, what is the type of `name` that SmartPy will automatically infer?**  
