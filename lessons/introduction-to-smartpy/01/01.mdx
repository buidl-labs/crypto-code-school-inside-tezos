...
<img src="https://media.giphy.com/media/FQyQEYd0KlYQ/giphy.gif" alt="drawing" style="margin-left: auto; margin-right: auto; width: 80%; display: block;"/>
...
In Chapter 0, you got the **seed** of a fabled plant that can kill zombies! Your task will be to evolve it into a full featured plant that can kill zombies like shown below: 
