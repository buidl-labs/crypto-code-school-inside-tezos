...
This is is the beginning of **Lesson 1** of **Alien Invasion** - an interactive code school that teaches you how to write smart contracts in SmartPy! 
...
In the [previous chapter](/tezos/storyline), you got the **gem** of a fabled Crypto bot that can kill aliens! Your task will be to evolve it into a full featured Crypto bot that can kill aliens:

To build the alien-killer Crypto bot, you are going to learn to write a basic **`CryptoBot` smart contract** that will contain all the abilities required to kill aliens in style! 
...
1. have the ability to **move around to hunt aliens**!
2. have the ability to **shoot bullet gem to kill aliens**!
3. have the ability to **record alien kills for post kill analysis**! 

In later lessons, we’ll add more functionality like evolving the `CryptoBot` to have the ability to shoot special moves, the ability to trade your CryptoBot with other #builder-s on the planet etc. 
