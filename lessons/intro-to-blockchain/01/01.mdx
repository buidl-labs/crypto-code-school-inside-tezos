...
This module is a non-technical intro to the mental models behind blockchain, the real programming starts from the next module - this module is getting you ready to #buidl 😎
...
- Open a [new issue on the project's Github.](https://github.com/buidl-labs/crypto-code-school-inside-tezos/issues/new/choose)
