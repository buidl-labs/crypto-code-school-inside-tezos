...
This seems awfully similar to if..then conditions doesn't it? 
...
**Smart contracts are simple agreements written in code that are stored and executed on the blockchain.**

A bet is simply an agreement between you and someone else, you can literally write a smart contract, put it on the blockchain and the smart contract will take care of all the work(checking who won and sending the reward) for the bet.

### But why codify a situation as a smart contract?
When you have an agreement among individuals, there is a need to **trust** the other party. Trust that they'll follow up on their end of the agreemeßnt.
