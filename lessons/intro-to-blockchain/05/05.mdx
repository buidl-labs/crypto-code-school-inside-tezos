...
But, the case for decentralized apps is different. Depending on which blockchain network you're using, some libraries let you communicate with the smart contract directly from the frontend Javascript code. For example, Taquito for Tezos, Web3.js for Ethereum. 
