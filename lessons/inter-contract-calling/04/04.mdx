...
### Study time
Records are the kind of structures that seem not of much use at first but turn out to be extremely crucial on taking a closer look, it's the underdog of types :dog: 
...
Confused? 
Take a look at the snippet below :arrow_down: 
```python=
