...
It can make your smart contracts go *super saiyan* :fire:.
...
#### New feature request!
It's time to build the functionality of buying a powerup from the `Market` finally :rocket: 
