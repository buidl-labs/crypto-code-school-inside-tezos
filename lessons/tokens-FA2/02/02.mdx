...
The series of following chapters will teach you all you need to know about FA2 to implement tokens using it! 🌍


## Study time

FA2 is the <span class="string-highlight">standard which defines a set way of how you would go about implementing a token</span>. 
...
2. Even if you end up implementing your tokens safely, how would anybody interact with them if they don't know how to? <span class="string-highlight">That's why a standard becomes a necessity because it defines a set of functionality and how to interact with it so that different services can integrate with your token.</span>
