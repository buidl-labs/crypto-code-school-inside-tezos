...
editor:
  ...
  startingCode: |
    ...
    .then(contract => {
        // transfer 2 tokens from `tz1WvExrfb4hPQZhoXeY8DqmmtvceYnDv8Pt` to `tz1YLnvKy2ycBZ9TpTCv9ngXd1eUw2uxzhDd`.
  ...
  answer: |
    ...
    .then(contract => {
        ...
        return contract.methods.transfer([
          {
            from_: "tz1WvExrfb4hPQZhoXeY8DqmmtvceYnDv8Pt",
...
1. Transfer 2 tokens of `token_id` 0 from your previous account(`tz1Q654L2qnt5mDM1Lbi4rMSTtnE5JHvD8M7`)(the one you used while minting the tokens) to this account - ``, which you generated right now. 

Take reference from the code snippet we explored above.