...
1. Create a new Faucet Account. 
    1. Go to https://faucet.tzalpha.net/
    2. Click on "Get testnet".
    3. Copy the generated JSON.
    4. Head over to smartpy.io/dev/wallet.html
    5. Click "Faucet Accounts" and then "Faucet" importer.
    6. Paste the JSON generated through faucet in the textarea below.
    7. Activate your account - 
        1. Click "Compute Private Key"
        2. Click "Save Account in Wallet"
        3. Click "Activate Account"
    8. Now, find **"pkh"** in the JSON that was generated through the faucet - this is the **address of the new test account you created right now, save this.**
2. Transfer 2 tokens of `token_id` 0 from your previous account(the one you used while minting the tokens) to the new account which you generated right now. Take reference from the code snippet we explored above.