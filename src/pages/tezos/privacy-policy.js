const PrivacyPolicy = () => {
  return (
    <div style={{ margin: 20 }}>
      <h2>Buidllabs Privacy Policy</h2>
      <p>
        This Privacy Policy describes how your personal information is
        collected, used, and shared when you visit or make a purchase from
        https://blissful-mcnulty-82f253.netlify.com/ (the “Site”).
      </p>
      ...
      <p>
        ...
        the following technologies: - “Cookies” are data files that are placed
        ...
        cookies, visit http://www.allaboutcookies.org. - “Log files” track
        ...
        and date/time stamps. - “Web beacons,” “tags,” and “pixels” are
        ...
        number. We refer to this information as “Order Information.” sWhen we
        talk about “Personal Information” in this Privacy Policy, we are talking
